...
const makeBook = (title, author, year, isCompleted) => {
  ...
  if(isCompleted) {
    image.setAttribute('src', 'https://i.pinimg.com/236x/71/1e/e0/711ee09757e70995b17268d389ecf7eb.jpg')
  } else {
    image.setAttribute('src', 'https://i.pinimg.com/236x/f1/f7/43/f1f743d3a65c99eccddf0873c814bd50.jpg')
  }
